...
|---|---|---|---|---|
| `GET` | `/metrics` | (none) | Prometheus text-exposition format | No auth required by default in `air_gapped`/`on_premise` mode (internal-only network); see `integrations/14_prometheus.md`. |
