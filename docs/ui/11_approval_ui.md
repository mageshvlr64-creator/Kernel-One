...
Empty: 'No pending approvals.' Loading: skeleton rows. Error: 'Could not submit decision — retry.' Permission-denied: panel entirely hidden/inaccessible for roles other than Administrator/SecurityOfficer (reference/05_permission_matrix.md).
