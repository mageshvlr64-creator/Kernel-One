...
View classification distribution and policy violations
...
Empty: 'No denied events in this period.' Loading: chart skeleton. Error: 'Could not load security data.' Permission-denied: 403 page for other roles.
