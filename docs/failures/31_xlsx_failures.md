...
Same class of failure as DOCX, specific to spreadsheet generation (formula errors, malformed cell references).

## Detection

Same validation pattern as `30_docx_failures.md`, using the XLSX library's own parse-back check.
