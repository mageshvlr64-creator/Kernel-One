...
|---|---|---|---|---|
| `GET` | `/api/v1/models` | query: ?capability | Model[] (`schemas/06_model_schema.md`) | Filters by `is_available=true` unless caller is Operator/Administrator. |
| `GET` | `/api/v1/models/{id}` | (none) | Model | — |
