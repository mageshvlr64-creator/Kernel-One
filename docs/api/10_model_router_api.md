...
|---|---|---|---|---|
| `POST` | `/api/v1/router/select` | {capability, classification, latency_target_ms?} | {model_id, fallback_model_id, reason, score} | Internal-primarily endpoint (`features/02_model_router/`); also callable directly for debugging by Operator/Administrator. |

## Example — POST /api/v1/router/select
