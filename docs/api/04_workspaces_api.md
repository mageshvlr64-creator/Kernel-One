...
|---|---|---|---|---|
| `GET` | `/api/v1/workspaces` | (none) | Workspace[] | Scoped to caller's organization. |
| `POST` | `/api/v1/workspaces` | {name, default_classification?} | Workspace | Requires `Administrator` or `Operator`. |

## Example — GET /api/v1/workspaces
