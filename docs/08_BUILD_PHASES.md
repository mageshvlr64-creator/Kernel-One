...
| **7 — Artifacts + approvals** | Agent produces a real DOCX with a human approval gate | `15_artifact_engine`, `16_human_approval` | Phase 6 | `TEST-APPROVAL-001` passes; generated `.docx` opens correctly in a real Office viewer |
